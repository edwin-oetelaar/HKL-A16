...
// Set the I2C address
PCF8574 pcf8574_1(0x22, 4, 5);  // Create a PCF8574 object with address 0x22 and specified pins
PCF8574 pcf8574_2(0x21, 4, 5);  // Create another PCF8574 object with different address
...
void setup() {
    ...
    pcf8574_2.pinMode(P0, INPUT);  // Set pin P0 of pcf8574_2 as input
    pcf8574_2.pinMode(P1, INPUT);  // Set pin P1 of pcf8574_2 as input
    pcf8574_2.pinMode(P2, INPUT);  // Set pin P2 of pcf8574_2 as input
    pcf8574_2.pinMode(P3, INPUT);  // Set pin P3 of pcf8574_2 as input
    pcf8574_2.pinMode(P4, INPUT);  // Set pin P4 of pcf8574_2 as input
    pcf8574_2.pinMode(P5, INPUT);  // Set pin P5 of pcf8574_2 as input
    pcf8574_2.pinMode(P6, INPUT);  // Set pin P6 of pcf8574_2 as input
    pcf8574_2.pinMode(P7, INPUT);  // Set pin P7 of pcf8574_2 as input
...
void loop() {
    ...
    uint8_t val9 = pcf8574_2.digitalRead(P0);  // Read digital value from pin P0 of pcf8574_2
    uint8_t val10 = pcf8574_2.digitalRead(P1);  // Read digital value from pin P1 of pcf8574_2
    uint8_t val11 = pcf8574_2.digitalRead(P2);  // Read digital value from pin P2 of pcf8574_2
    uint8_t val12 = pcf8574_2.digitalRead(P3);  // Read digital value from pin P3 of pcf8574_2
    uint8_t val13 = pcf8574_2.digitalRead(P4);  // Read digital value from pin P4 of pcf8574_2
    uint8_t val14 = pcf8574_2.digitalRead(P5);  // Read digital value from pin P5 of pcf8574_2
    uint8_t val15 = pcf8574_2.digitalRead(P6);  // Read digital value from pin P6 of pcf8574_2
    uint8_t val16 = pcf8574_2.digitalRead(P7);  // Read digital value from pin P7 of pcf8574_2
